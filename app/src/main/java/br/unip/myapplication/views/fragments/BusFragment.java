...
public class BusFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mRecyclerView = (RecyclerView) inflater.inflate(R.layout.fragment_bus, container, false);
    ...
    public void setupRecyclerView(RecyclerView recyclerView) {
        ...
        final List<Location> locations = location.getAll(LocationType.BUS);
        ...
        ListingAdapter listingAdapter = new ListingAdapter(locations, new ListingAdapter.OnLocationClickListener() {
            ...
            public void onLocationClick() {
                Uri gmmIntentUri;
                final String uriCordinatesBus = "geo:" + myLocation.getLatitude(getActivity()) + "," + myLocation.getLongitude(getActivity()) + "?q=" + getString(R.string.str_bus);
